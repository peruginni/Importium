...
class Image
{
    ...
    /** @OneToOne(targetEntity="\CMS\Entity\File") */
    private $file;

    /** @Column(type="string") */
    private $description;

    /** @OneToMany(targetEntity="\CMS\Entity\Image", mappedBy="sourceImage") */
    private $thumbnails;

    /** @ManyToOne(targetEntity="\CMS\Entity\Image", inversedBy="thumbnails") */
    private $sourceImage;
